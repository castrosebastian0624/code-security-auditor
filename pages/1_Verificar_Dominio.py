...
No hay autenticación real: el "usuario" se identifica por el email que
escribe. Es una limitación conocida y documentada (ver db_pivot.py) — no se
esconde en la UI, no se debe cobrar nada apoyado en esta identidad hasta que
haya un mecanismo de auth real.
================================================================================
"""
...
# ==============================================================================
# 1. Identificación mínima (email)
# ==============================================================================
st.markdown("### 1. ¿Quién eres?")
...
if email:
    if not EMAIL_REGEX.match(email.strip()):
        ...
        usuario_id = db_pivot.obtener_o_crear_usuario(email.strip())
...
if usuario_id:
    ...
    st.info("👆 Ingresa tu email para empezar.")
